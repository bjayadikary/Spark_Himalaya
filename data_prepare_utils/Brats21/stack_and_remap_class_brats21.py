...
def main():
    ...
    if args.flag == 'train':
        destination_images_dir = os.path.join(os.getcwd(), 'BRATS/stacked', 'TrainVolumes')
        destination_labels_dir = os.path.join(os.getcwd(), 'BRATS/stacked', 'TrainSegmentations')
    elif args.flag == 'val':
        destination_images_dir = os.path.join(os.getcwd(), 'BRATS/stacked', 'ValVolumes')
        destination_labels_dir = os.path.join(os.getcwd(), 'BRATS/stacked', 'ValSegmentations')
    elif args.flag == 'test':
        destination_images_dir = os.path.join(os.getcwd(), 'BRATS/stacked', 'TestVolumes')
        destination_labels_dir = os.path.join(os.getcwd(), 'BRATS/stacked', 'TestSegmentations') 
    else:
